...
void Sub::handle_jsbutton_press(uint8_t _button, bool shift, bool held)
{
    ...
    case JSButton::button_function_t::k_mode_manual:
        ...
        break;
    case JSButton::button_function_t::k_mode_manual_pro:
        set_mode(MANUAL_PRO, ModeReason::RC_COMMAND);
        break;
...
{
    JSButton::button_function_t defaults[17][2] = {
        ...
        {JSButton::button_function_t::k_mode_manual_pro, JSButton::button_function_t::k_none},
